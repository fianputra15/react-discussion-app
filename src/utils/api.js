const api = (() => {
  ...
  async function createComment({ threadId, threadComment }) {
  ...
  async function toggleUpCommentThread({ threadId, commentId }) {
  ...
  async function toggleDownCommentThread({ threadId, commentId }) {
  ...
  async function toggleNeutralizeCommentThread({ threadId, commentId }) {
  ...
  return {
    ...
    toggleUpCommentThread,
    toggleDownCommentThread,
    toggleNeutralizeCommentThread,
    getThreadDetail,
    createComment,
    getLeaderboardList,
  };
